...
';
$GLOBALS['TL_DCA']['tl_content']['palettes']['__selector__'][] = 'addProduktImage';
$GLOBALS['TL_DCA']['tl_content']['subpalettes']['addProduktImage'] = 'singleSRC';
$GLOBALS['TL_DCA']['tl_content']['fields']['addProduktImage'] = [
    'inputType'               => 'checkbox',
    'eval'                    => array('submitOnChange' => true, 'tl_class' => 'w100 m12 cbx'),
    'sql'                     => array('type' => 'boolean', 'default' => false)
];
$GLOBALS['TL_DCA']['tl_content']['palettes']['__selector__'][] = 'addGlobalLink';
$GLOBALS['TL_DCA']['tl_content']['subpalettes']['addGlobalLink'] = 'url,target,titleText';
