...
PaletteManipulator::create()
  ->addLegend('megamenu_legend:hide', 'layout_legend', PaletteManipulator::POSITION_AFTER)
  ->addField('addMegaMenu', 'megamenu_legend:hide', PaletteManipulator::POSITION_APPEND)
