...
/**
 * @ContentElement("product_box_single", category="product_box", template="product_box_single")
 */
class ProductBox extends AbstractContentElementController
{
    ...
    protected function getResponse(
        ...
        $template->headline = StringUtil::deserialize($model->headline)[
            "value"
        ];
        ...
        if ($template->addImage && !empty($model->singleSRC)) {
            ...
            $figureBuilder->from($model->singleSRC)->setSize($model->size);
